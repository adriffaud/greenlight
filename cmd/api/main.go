...
import (
	...
	"github.com/adriffaud/greenlight/internal/data"
	"github.com/adriffaud/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smt-sender", "Greenlight <no-reply@greenlight.driffaud.fr>", "SMTP sender")
